...
public class UraniumFluidBlock extends ReduxBaseFluid {
	
	public UraniumFluidBlock(Fluid fluid, Material material) {
		super(fluid, material);

		damageValue = FluidDamageValues.URANIUM_DAMAGE_VALUE.ordinal();
	}
	
	@Override
    public void func_180634_a(World world, BlockPos pos, IBlockState state, Entity entity){
		entityCollideCheck(world, pos, state, entity, uraniumDamage);
	}
}
