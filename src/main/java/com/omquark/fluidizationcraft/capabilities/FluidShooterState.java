...
//    public static final FluidShooterState EMPTY = new FluidShooterState(ItemStack.EMPTY, ItemStack.EMPTY, null, 0);
    public static final FluidShooterState EMPTY = new FluidShooterState(Optional.of(ItemStack.EMPTY), Optional.of(ItemStack.EMPTY), null, 0);
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, FluidShooterState> STREAM_CODEC = StreamCodec.of((buf, state) -> {
                buf.writeOptional(state.input(), ItemStack.STREAM_CODEC);ItemStack.STREAM_CODEC.encode(buf, state.input().orElse(ItemStack.EMPTY));
            ...
            buf -> {
                ...
                return new FluidShooterState(Optional.of(input), Optional.of(output), fluid.orElse(null), amount);
            });
}
